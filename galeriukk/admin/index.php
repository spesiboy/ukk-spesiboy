    ...
    <a type="button" data-bs-toggle="modal" data-bs-target="#komentar<?php echo $data['fotoid'] ?>">
            ...
            <div class="card-footer text-center">
                ...
                if (mysqli_num_rows($ceksuka) == 1) { ?>
                    <a href="../config/proses_like.php?fotoid=<?php echo $data['fotoid'] ?>" type="submit" name="batalsuka"><i class="fas fa-heart" style="color: red;"></i></a>

                <?php } else { ?>
                  <a href="../config/proses_like.php?fotoid=<?php echo $data['fotoid'] ?>&aksi=suka" type="submit" name="suka"><i class="fa-regular fa-heart" style="color: red;"></i></a>


                <?php }

                $like = mysqli_query($koneksi, "SELECT * FROM likefoto WHERE fotoid='$fotoid'");
                echo mysqli_num_rows($like) . ' 赞';
                ...
                echo mysqli_num_rows($jmlkomen).' 评论';
                ?>
            </div>
        </div>
